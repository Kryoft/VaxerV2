...
public class Utility {
    ...
    */
    ...
    public Indirizzo_composto.Qualificatore DecidiQualifier(String tipo){
    if(tipo.equals("PIAZZA")){
            return Indirizzo_composto.Qualificatore.PIAZZA; 
        }
        if(tipo.equals("VIA")){
            return Indirizzo_composto.Qualificatore.VIA; 
        }
        if(tipo.equals("VIALE")){
            return Indirizzo_composto.Qualificatore.VIALE; 
        }
    return null;
    }
