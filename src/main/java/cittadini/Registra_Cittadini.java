                ...
                if(!user.equals("user id")&& !Nome.equals("nome") && !Cognome.equals("cognome")&& !password.equals("password") && !Codice.equals("") && !email.equals("email") && !user.equals("")&& !Nome.equals("") && !Cognome.equals("")&& !password.equals("") && !email.equals("") )
                {
                    ...
                    try{
                        if(!c.mailSyntaxCheck(email)){
                            txtemail.setBorder(new LineBorder(java.awt.Color.RED, 3, true));
                        ...
                        if(u.controllocf(Codice,id,"./data/Vaccinati_"+ Centro + ".dati.txt")){
                            ...
                            if(u.ControlloLogin(l.toString(),"./data/log.txt")==false)
                            {
                                ...
                                txtuser.setBorder(new LineBorder(java.awt.Color.RED, 3, true));
                                txtpassword.setBorder(new LineBorder(java.awt.Color.RED, 3, true));
                            ...
                            txtuser.setBorder(border);
                            txtemail.setBorder(border);
                            txtid.setBorder(new LineBorder(java.awt.Color.RED, 3, true));
                            txtcodice.setBorder(new LineBorder(java.awt.Color.RED, 3, true));
                        ...
                        txtcentro.setBorder(new LineBorder(java.awt.Color.RED, 3, true));
            ...
            if(e.getSource() == c2){
                ...
                if(u.EsisteCentro(0,centro,"./data/CentriVaccinali.dati.txt")){  
                    ...
                    if(!centro.equals("")&& !Evento.equals("")){
                        ...
                        {
                            txtindice.setBorder(new LineBorder(java.awt.Color.RED, 3, true));
