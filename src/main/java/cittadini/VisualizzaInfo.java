...
public class VisualizzaInfo extends JFrame implements ActionListener {
     ...
     */
     private void init(StruttureVaccinali sv){
        ...
        lblindirizzo = new JLabel("Indirizzo: " + sv.getIndirizzo().getQualificatore() + " " + sv.getIndirizzo().getNome_via() + " " + sv.getIndirizzo().getNum_civico());
        lblcomune = new JLabel("Comune: " + sv.getIndirizzo().getComune());
        lblsigla = new JLabel("Sigla :" + sv.getIndirizzo().getSigla_provincia());
